	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.ObservabilityV1alpha1().Tenants().List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.ObservabilityV1alpha1().Tenants().Watch(context.TODO(), options)
			},
		},
		&observabilityv1alpha1.Tenant{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *tenantInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&observabilityv1alpha1.Tenant{}, f.defaultInformer)
}
