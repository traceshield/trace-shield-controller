...
# Needed since the types container float64
CRD_OPTIONS ?= crd:allowDangerousTypes=true,ignoreUnexportedFields=true
...
run: manifests generate fmt vet ## Run a controller from your host.
	go run ./cmd/main.go -zap-devel -zap-log-level 2
